...
public class ValidacaoTipoNotificacaoNotificarViaSMS
        extends
        ValidacaoGenerica<TipoNotificacao> {

    public ValidacaoTipoNotificacaoNotificarViaSMS(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public List validar(java.lang.Object o) throws ErroValidacao {
        ...
        if (valor) {
            if (!ERPTipoCanalComunicacao.SMS.isTipoTransporteImplementado()) {
                throw new ErroValidacao("Importe o pacote para implementar esse tipo de disparo br.org.coletivoJava.fw.api.erp.comunicacao.canais.SbErpTipoCanalSMS");
            }
        }
