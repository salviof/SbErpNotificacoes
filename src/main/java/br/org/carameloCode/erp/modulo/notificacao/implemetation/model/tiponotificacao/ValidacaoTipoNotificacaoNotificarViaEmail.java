...
public class ValidacaoTipoNotificacaoNotificarViaEmail
        extends
        ValidacaoGenerica<TipoNotificacao> {

    public ValidacaoTipoNotificacaoNotificarViaEmail(ItfCampoInstanciado pCampo) {
        super(pCampo);
    }
    ...
    public List validar(java.lang.Object o) throws ErroValidacao {
        ...
        if (valor) {
            if (!ERPTipoCanalComunicacao.EMAIL.isTipoTransporteImplementado()) {
                throw new ErroValidacao("Importe o pacote para implementar esse tipo de disparo br.org.coletivoJava.fw.api.erp.comunicacao.canais.SbErpTipoCanalEmail");
            }
        }
