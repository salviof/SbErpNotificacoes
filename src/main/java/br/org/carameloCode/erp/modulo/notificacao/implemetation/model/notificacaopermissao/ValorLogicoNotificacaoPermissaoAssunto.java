...
@ValorLogicoNotificacaoPermissao(calculo = ValoresLogicosNotificacaoPermissao.ASSUNTO)
public class ValorLogicoNotificacaoPermissaoAssunto
		extends
			ValorLogicoCalculoGenerico {

	public ValorLogicoNotificacaoPermissaoAssunto(ItfCampoInstanciado pCampo) {
		super(pCampo);
	}
